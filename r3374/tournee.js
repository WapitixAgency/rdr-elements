/* rdr-elements tournee | source route-du-rhum 6bcc305 | tournee-map.js */
try{(window.RDR_ELEMENTS=window.RDR_ELEMENTS||{})["tournee"]="6bcc305";performance.mark("rdr-elements:tournee")}catch(e){}
;(function(){
(function () {
'use strict';
