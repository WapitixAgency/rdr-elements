/* rdr-elements programme | source route-du-rhum 1e54be5 | rdr-programme.js */
try{(window.RDR_ELEMENTS=window.RDR_ELEMENTS||{})["programme"]="1e54be5";performance.mark("rdr-elements:programme")}catch(e){}
;(function(){
(() => {
  'use strict';
