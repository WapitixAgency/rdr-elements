...
addEventListener('scroll', () => {
  ...
  class RdrParcours extends HTMLElement {
    ...
    _tenter(jeu) {
      ...
      if (!valide(D)) {
        if (!this.firstChild) this.innerHTML = "<div class=\"rpa-attente\" aria-hidden=\"true\"><div class=\"rpa-sq-haut\"><div class=\"rpa-sq-trame\"><i class=\"rpa-sq-l rpa-sq-k\"></i><i class=\"rpa-sq-l rpa-sq-t\"></i><i class=\"rpa-sq-l rpa-sq-t rpa-sq-t2\"></i><i class=\"rpa-sq-l rpa-sq-p rpa-sq-p1\"></i><i class=\"rpa-sq-l rpa-sq-p\"></i><i class=\"rpa-sq-l rpa-sq-p rpa-sq-p3\"></i></div></div></div>";
        return;
      }
      this._monte = true;
    ...
    _panne() {
      ...
      this.querySelector('button').addEventListener('click', () => { this.innerHTML = "<div class=\"rpa-attente\" aria-hidden=\"true\"><div class=\"rpa-sq-haut\"><div class=\"rpa-sq-trame\"><i class=\"rpa-sq-l rpa-sq-k\"></i><i class=\"rpa-sq-l rpa-sq-t\"></i><i class=\"rpa-sq-l rpa-sq-t rpa-sq-t2\"></i><i class=\"rpa-sq-l rpa-sq-p rpa-sq-p1\"></i><i class=\"rpa-sq-l rpa-sq-p\"></i><i class=\"rpa-sq-l rpa-sq-p rpa-sq-p3\"></i></div></div></div>"; this._chercher(); });
    }
  }
