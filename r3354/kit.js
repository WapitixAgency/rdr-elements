...
monter(D.lang in KIT.langues ? D.lang : Object.keys(KIT.langues)[0]);
  ...
  class RdrKitPedagogique extends HTMLElement {
    ...
    _tenter(jeu) {
      ...
      if (!this._valide(D)) {
        if (!this.firstChild) this.innerHTML = "<div class=\"rkp-attente\" aria-hidden=\"true\"><div class=\"rkp-sq-haut\"><div class=\"rkp-sq-trame\"><i class=\"rkp-sq-l rkp-sq-k\"></i><i class=\"rkp-sq-l rkp-sq-t\"></i><i class=\"rkp-sq-l rkp-sq-t rkp-sq-t2\"></i><i class=\"rkp-sq-l rkp-sq-p rkp-sq-p1\"></i><i class=\"rkp-sq-l rkp-sq-p\"></i><i class=\"rkp-sq-l rkp-sq-p rkp-sq-p3\"></i></div></div></div>";
        return;
      }
      this._monte = true;
    ...
    _panne() {
      ...
      this.querySelector('button').addEventListener('click', () => { this.innerHTML = "<div class=\"rkp-attente\" aria-hidden=\"true\"><div class=\"rkp-sq-haut\"><div class=\"rkp-sq-trame\"><i class=\"rkp-sq-l rkp-sq-k\"></i><i class=\"rkp-sq-l rkp-sq-t\"></i><i class=\"rkp-sq-l rkp-sq-t rkp-sq-t2\"></i><i class=\"rkp-sq-l rkp-sq-p rkp-sq-p1\"></i><i class=\"rkp-sq-l rkp-sq-p\"></i><i class=\"rkp-sq-l rkp-sq-p rkp-sq-p3\"></i></div></div></div>"; this._chercher(); });
    }
  }
