...
new ResizeObserver(() => { clearTimeout(attente); attente = setTimeout(tracerFil, 120); }).observe(fil);
  ...
  class RdrCourse extends HTMLElement {
    ...
    _tenter(jeu) {
      ...
      if (!valide(D)) {
        if (!this.firstChild) this.innerHTML = "<div class=\"rco-attente\" aria-hidden=\"true\"><div class=\"rco-sq-haut\"><div class=\"rco-sq-trame\"><i class=\"rco-sq-l rco-sq-k\"></i><i class=\"rco-sq-l rco-sq-t\"></i><i class=\"rco-sq-l rco-sq-t rco-sq-t2\"></i><i class=\"rco-sq-l rco-sq-p rco-sq-p1\"></i><i class=\"rco-sq-l rco-sq-p\"></i><i class=\"rco-sq-l rco-sq-p rco-sq-p3\"></i></div></div><div class=\"rco-sq-trame rco-sq-cartes\"><i class=\"rco-sq-c\"></i><i class=\"rco-sq-c\"></i><i class=\"rco-sq-c\"></i></div></div>";
        return;
      }
      this._monte = true;
    ...
    _panne() {
      ...
      this.querySelector('button').addEventListener('click', () => { this.innerHTML = "<div class=\"rco-attente\" aria-hidden=\"true\"><div class=\"rco-sq-haut\"><div class=\"rco-sq-trame\"><i class=\"rco-sq-l rco-sq-k\"></i><i class=\"rco-sq-l rco-sq-t\"></i><i class=\"rco-sq-l rco-sq-t rco-sq-t2\"></i><i class=\"rco-sq-l rco-sq-p rco-sq-p1\"></i><i class=\"rco-sq-l rco-sq-p\"></i><i class=\"rco-sq-l rco-sq-p rco-sq-p3\"></i></div></div><div class=\"rco-sq-trame rco-sq-cartes\"><i class=\"rco-sq-c\"></i><i class=\"rco-sq-c\"></i><i class=\"rco-sq-c\"></i></div></div>"; this._chercher(); });
    }
  }
