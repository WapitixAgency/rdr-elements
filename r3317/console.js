/* rdr-elements console | source route-du-rhum 50be8a1 | rdr-console.js */
try{(window.RDR_ELEMENTS=window.RDR_ELEMENTS||{})["console"]="50be8a1";performance.mark("rdr-elements:console")}catch(e){}
;(function(){
(function () {
  'use strict';
