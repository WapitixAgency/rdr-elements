/* rdr-elements concours | source route-du-rhum 8abbdb1 | rdr-concours-photo.js */
try{(window.RDR_ELEMENTS=window.RDR_ELEMENTS||{})["concours"]="8abbdb1";performance.mark("rdr-elements:concours")}catch(e){}
;(function(){
(function () {
  'use strict';
