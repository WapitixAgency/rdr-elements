/* rdr-elements entete | source route-du-rhum 0ee490c | rdr-entete.js */
try{(window.RDR_ELEMENTS=window.RDR_ELEMENTS||{})["entete"]="0ee490c";performance.mark("rdr-elements:entete")}catch(e){}
;(function(){
...
const TXTS = {
  fr: { depart: 'Départ', J: 'J-', partenaires: 'Partenaires institutionnels', menu: 'MENU', fermer: 'FERMER' },
  en: { depart: 'Start', J: 'D-', partenaires: 'Institutional partners', menu: 'MENU', fermer: 'CLOSE' }
};
...
function creerTelephone(o) {
  ...
  function html() {
    ...
    return '<div class="gt-ruban">' + langues +
        ...
        (R.alpina ? '<a class="gt-alpina" href="' + esc(R.alpina.lien) + '" target="_blank" rel="noopener"><img src="' + esc(R.alpina.logo) + '" alt="' + esc(R.alpina.alt) + '" height="15" decoding="async">' + nouvelOnglet(R.alpina.lien) + '</a>' : '') +
        '<div class="gt-pille">' +
