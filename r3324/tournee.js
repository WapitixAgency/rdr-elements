/* rdr-elements tournee | source route-du-rhum 50be8a1 | tournee-map.js */
try{(window.RDR_ELEMENTS=window.RDR_ELEMENTS||{})["tournee"]="50be8a1";performance.mark("rdr-elements:tournee")}catch(e){}
;(function(){
(function () {
'use strict';
