/* rdr-elements programme | source route-du-rhum 50be8a1 | rdr-programme.js */
try{(window.RDR_ELEMENTS=window.RDR_ELEMENTS||{})["programme"]="50be8a1";performance.mark("rdr-elements:programme")}catch(e){}
;(function(){
(() => {
  'use strict';
