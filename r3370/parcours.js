...
document.getElementById('obs-grille').innerHTML = P.obstacles.map((o, i) =>
  ...
  '<div class="obs-corps"><small>Avis aux navigateurs n°&nbsp;<span>' + (i + 1) + '</span></small><h3>' + o.t + '</h3><p>' + o.x + (o.valide ? '' : '<span class="a-valider">texte proposé</span>') + '</p><span class="obs-ou">' + pic('mapPin') + o.ou + '</span></div></article>').join('');
