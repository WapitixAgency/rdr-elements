/* rdr-elements programme | source route-du-rhum 6bcc305 | rdr-programme.js */
try{(window.RDR_ELEMENTS=window.RDR_ELEMENTS||{})["programme"]="6bcc305";performance.mark("rdr-elements:programme")}catch(e){}
;(function(){
(() => {
  'use strict';
