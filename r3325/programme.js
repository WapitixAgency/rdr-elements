/* rdr-elements programme | source route-du-rhum ed1e646 | rdr-programme.js */
try{(window.RDR_ELEMENTS=window.RDR_ELEMENTS||{})["programme"]="ed1e646";performance.mark("rdr-elements:programme")}catch(e){}
;(function(){
(() => {
  'use strict';
