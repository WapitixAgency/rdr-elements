/* rdr-elements programme | source route-du-rhum fdaf435 | rdr-programme.js */
try{(window.RDR_ELEMENTS=window.RDR_ELEMENTS||{})["programme"]="fdaf435";performance.mark("rdr-elements:programme")}catch(e){}
;(function(){
(() => {
  'use strict';
