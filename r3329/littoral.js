...
arriver();
  ...
  class RdrLittoral extends HTMLElement {
    ...
    _tenter(jeu) {
      ...
      if (!this._valide(D)) {
        if (!this.firstChild) this.innerHTML = "<div class=\"rlt-attente\" aria-hidden=\"true\"><div class=\"rlt-sq-haut\"><div class=\"rlt-sq-trame\"><i class=\"rlt-sq-l rlt-sq-k\"></i><i class=\"rlt-sq-l rlt-sq-t\"></i><i class=\"rlt-sq-l rlt-sq-t rlt-sq-t2\"></i><i class=\"rlt-sq-l rlt-sq-p rlt-sq-p1\"></i><i class=\"rlt-sq-l rlt-sq-p\"></i><i class=\"rlt-sq-l rlt-sq-p rlt-sq-p3\"></i></div></div></div>";
        return;
      }
      this._monte = true;
    ...
    _panne() {
      ...
      this.querySelector('button').addEventListener('click', () => { this.innerHTML = "<div class=\"rlt-attente\" aria-hidden=\"true\"><div class=\"rlt-sq-haut\"><div class=\"rlt-sq-trame\"><i class=\"rlt-sq-l rlt-sq-k\"></i><i class=\"rlt-sq-l rlt-sq-t\"></i><i class=\"rlt-sq-l rlt-sq-t rlt-sq-t2\"></i><i class=\"rlt-sq-l rlt-sq-p rlt-sq-p1\"></i><i class=\"rlt-sq-l rlt-sq-p\"></i><i class=\"rlt-sq-l rlt-sq-p rlt-sq-p3\"></i></div></div></div>"; this._chercher(); });
    }
  }
