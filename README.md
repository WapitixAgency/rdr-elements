...
| `carte.js` | la carte du village ; ses données sont déjà dans le HTML servi, et MapLibre est préchargé avec elle :  | 430.3 Ko, 94.7 Ko brotli |
...
Source : `WapitixAgency/route-du-rhum 957222d`.
