...
| `carte.js` | la carte du village ; ses données sont déjà dans le HTML servi, et MapLibre est préchargé avec elle :  | 387.0 Ko, 85.6 Ko brotli |
...
Source : `WapitixAgency/route-du-rhum a56846c`.
