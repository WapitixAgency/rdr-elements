...
| `apercu.js` | l'aperçu de l'accueil V3 (rdr-accueil-apercu), chargé sur toute page qui porte la balise : rdr-accueil-apercu | 125.1 Ko, 25.1 Ko brotli |
...
| `reglements.js` | les règlements des jeux et concours (23/09) ; les textes sont dans le module, il se dessine seul : rdr-reglements | 57.1 Ko, 13.2 Ko brotli |
...
Source : `WapitixAgency/route-du-rhum c63776e`.
