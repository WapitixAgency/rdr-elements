...
| `atelier.js` | l'atelier du village (village-atelier, l'outil de l'équipe pour éditer la carte, sur ordinateur) ; le plus gros module du site après l'Espace Rhum (168 Ko brotli), MapLibre préchargé comme pour la carte :  | 761.6 Ko, 173.6 Ko brotli |
...
| `course.js` | les petits modules éditoriaux des anciennes pages Bateaux et Terres d'engagements ; leurs charges sont des attributs du HTML servi. La course (rdr-course) et Héritage (rdr-heritage) ont été publiées en modules le 25/09 : faits-marquants, manifeste-cartes et heritage-timeline en sont sortis : boat-diagram, pactes-tabs | 36.1 Ko, 9.0 Ko brotli |
...
Source : `WapitixAgency/route-du-rhum 05212f4`.
