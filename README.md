...
| `carte.js` | la carte du village ; ses données sont déjà dans le HTML servi, et MapLibre est préchargé avec elle :  | 452.6 Ko, 99.6 Ko brotli |
| `atelier.js` | l'atelier du village (village-atelier, l'outil de l'équipe pour éditer la carte, sur ordinateur) ; le plus gros module du site après l'Espace Rhum (168 Ko brotli), MapLibre préchargé comme pour la carte :  | 745.9 Ko, 169.4 Ko brotli |
...
| `apercu.js` | l'aperçu de l'accueil V3 (rdr-accueil-apercu), chargé sur toute page qui porte la balise : rdr-accueil-apercu | 113.8 Ko, 23.0 Ko brotli |
...
Source : `WapitixAgency/route-du-rhum f5019be`.
