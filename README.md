...
| --- | --- | --- |
| `socle.js` | les six méga menus, les deux horloges de l'en-tête et le haut du pied de page, sur toutes les pages : rdr-menu-actus, rdr-menu-cartes, timer-clock-simple, alpina-clock, rdr-pied-haut | 105.5 Ko, 20.9 Ko brotli |
...
| `carte.js` | la carte du village ; ses données sont déjà dans le HTML servi, et MapLibre est préchargé avec elle :  | 450.5 Ko, 99.3 Ko brotli |
...
Source : `WapitixAgency/route-du-rhum c786c2a`.
