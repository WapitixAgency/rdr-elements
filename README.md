...
| `programme.js` | la Programmation ; sa charge utile (133 Ko) est dans le HTML servi, le module est la page : rdr-programme | 193.3 Ko, 41.0 Ko brotli |
...
| `esk.js` | l'Espace skippers (rdr-espace-skippers, 26/09) : son jeu, lu en direct au CMS (ESPACESKIPPER), arrive en attribut jeu, posé par la page maître au rendu serveur :  | 35.9 Ko, 9.1 Ko brotli |
...
Source : `WapitixAgency/route-du-rhum a72ca9d`.
