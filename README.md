...
| `carte.js` | la carte du village ; ses données sont déjà dans le HTML servi, et MapLibre est préchargé avec elle :  | 452.7 Ko, 99.6 Ko brotli |
...
Source : `WapitixAgency/route-du-rhum d90f933`.
