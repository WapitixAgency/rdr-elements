...
arriver();
  ...
  class RdrLittoral extends HTMLElement {
    ...
    _tenter(jeu) {
      ...
      if (!this._valide(D)) {
        if (!this.firstChild) this.innerHTML = '<div class="rlt-attente" aria-hidden="true"></div>';
        return;
      }
      this._monte = true;
    ...
    _panne() {
      ...
      this.querySelector('button').addEventListener('click', () => { this.innerHTML = '<div class="rlt-attente" aria-hidden="true"></div>'; this._chercher(); });
    }
  }
