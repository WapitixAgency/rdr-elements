/* rdr-elements console | source route-du-rhum db0b578 | rdr-console.js */
try{(window.RDR_ELEMENTS=window.RDR_ELEMENTS||{})["console"]="db0b578";performance.mark("rdr-elements:console")}catch(e){}
;(function(){
(function () {
  'use strict';
