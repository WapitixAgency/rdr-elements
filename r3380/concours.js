/* rdr-elements concours | source route-du-rhum eab1d5d | rdr-concours-photo.js */
try{(window.RDR_ELEMENTS=window.RDR_ELEMENTS||{})["concours"]="eab1d5d";performance.mark("rdr-elements:concours")}catch(e){}
;(function(){
(function () {
  'use strict';
