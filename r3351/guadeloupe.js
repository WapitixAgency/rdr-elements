...
function monter(cle) {
  ...
  class RdrGuadeloupe extends HTMLElement {
    ...
    _tenter(jeu) {
      ...
      if (!valide(D)) {
        if (!this._monte && !this.firstChild) this.innerHTML = '<div class="rgd-attente" aria-hidden="true"></div>';
        return;
      }
    ...
    _panne() {
      ...
      this.querySelector('button').addEventListener('click', () => { this.innerHTML = '<div class="rgd-attente" aria-hidden="true"></div>'; this._chercher(); });
    }
  }
