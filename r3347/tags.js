/* rdr-elements tags | source route-du-rhum 4cacccc | rdr-tags.js */
try{(window.RDR_ELEMENTS=window.RDR_ELEMENTS||{})["tags"]="4cacccc";performance.mark("rdr-elements:tags")}catch(e){}
;(function(){
(() => {
  'use strict';
