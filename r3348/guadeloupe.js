...
function monter(cle) {
  ...
  class RdrGuadeloupe extends HTMLElement {
    ...
    _tenter(jeu) {
      ...
      if (!valide(D)) {
        if (!this._monte && !this.firstChild) this.innerHTML = "<div class=\"rgd-attente\" aria-hidden=\"true\"><div class=\"rgd-sq-haut\"><div class=\"rgd-sq-trame\"><i class=\"rgd-sq-l rgd-sq-k\"></i><i class=\"rgd-sq-l rgd-sq-t\"></i><i class=\"rgd-sq-l rgd-sq-t rgd-sq-t2\"></i><i class=\"rgd-sq-l rgd-sq-p rgd-sq-p1\"></i><i class=\"rgd-sq-l rgd-sq-p\"></i><i class=\"rgd-sq-l rgd-sq-p rgd-sq-p3\"></i></div></div><div class=\"rgd-sq-trame rgd-sq-cartes\"><i class=\"rgd-sq-c\"></i><i class=\"rgd-sq-c\"></i><i class=\"rgd-sq-c\"></i></div></div>";
        return;
      }
    ...
    _panne() {
      ...
      this.querySelector('button').addEventListener('click', () => { this.innerHTML = "<div class=\"rgd-attente\" aria-hidden=\"true\"><div class=\"rgd-sq-haut\"><div class=\"rgd-sq-trame\"><i class=\"rgd-sq-l rgd-sq-k\"></i><i class=\"rgd-sq-l rgd-sq-t\"></i><i class=\"rgd-sq-l rgd-sq-t rgd-sq-t2\"></i><i class=\"rgd-sq-l rgd-sq-p rgd-sq-p1\"></i><i class=\"rgd-sq-l rgd-sq-p\"></i><i class=\"rgd-sq-l rgd-sq-p rgd-sq-p3\"></i></div></div><div class=\"rgd-sq-trame rgd-sq-cartes\"><i class=\"rgd-sq-c\"></i><i class=\"rgd-sq-c\"></i><i class=\"rgd-sq-c\"></i></div></div>"; this._chercher(); });
    }
  }
