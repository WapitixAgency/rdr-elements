/* rdr-elements console | source route-du-rhum bd0e5ed | rdr-console.js */
try{(window.RDR_ELEMENTS=window.RDR_ELEMENTS||{})["console"]="bd0e5ed";performance.mark("rdr-elements:console")}catch(e){}
;(function(){
(function () {
  'use strict';
