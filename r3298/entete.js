/* rdr-elements entete | source route-du-rhum c63776e | rdr-entete.js */
try{(window.RDR_ELEMENTS=window.RDR_ELEMENTS||{})["entete"]="c63776e";performance.mark("rdr-elements:entete")}catch(e){}
;(function(){
    ...
    return '<div class="gt-ruban">' + langues +
      ...
      '<div class="gt-coque"><div class="gt-rangee">' +
        ...
        '<div class="gt-instr" role="timer" aria-label="' + esc(T.compte) + '"><span class="gt-chrono">' + montreHTML() +
          (R.alpina && R.alpina.logoSombre ? '<img class="gt-alpina-m" src="' + esc(R.alpina.logoSombre) + '" alt="" width="35" height="8" decoding="async">' : '') + '</span>' +
