/* rdr-elements tags | source route-du-rhum f7f0ed9 | rdr-tags.js */
try{(window.RDR_ELEMENTS=window.RDR_ELEMENTS||{})["tags"]="f7f0ed9";performance.mark("rdr-elements:tags")}catch(e){}
;(function(){
(() => {
  'use strict';
