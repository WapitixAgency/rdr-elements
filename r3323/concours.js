/* rdr-elements concours | source route-du-rhum db0b578 | rdr-concours-photo.js */
try{(window.RDR_ELEMENTS=window.RDR_ELEMENTS||{})["concours"]="db0b578";performance.mark("rdr-elements:concours")}catch(e){}
;(function(){
(function () {
  'use strict';
