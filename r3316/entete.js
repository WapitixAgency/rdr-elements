/* rdr-elements entete | source route-du-rhum 48ee719 | rdr-entete.js */
try{(window.RDR_ELEMENTS=window.RDR_ELEMENTS||{})["entete"]="48ee719";performance.mark("rdr-elements:entete")}catch(e){}
;(function(){
...
const TXTS = {
  fr: { depart: 'Départ', J: 'J-', partenaires: 'Partenaires institutionnels', boutique: ['Boutique et jeu', 'officiels'], menu: 'MENU', fermer: 'FERMER' },
  en: { depart: 'Start', J: 'D-', partenaires: 'Institutional partners', boutique: ['Official', 'store and game'], menu: 'MENU', fermer: 'CLOSE' }
};
...
function creerTelephone(o) {
  ...
  function html() {
    ...
    const libEtat = (l) => '<span class="gt-lib-etat">' + (l ? '<b>' + esc(l[0]) + '</b><em>' + esc(l[1]) + '</em>' : '') + '</span>';
    ...
    return '<div class="gt-ruban">' + langues +
        '<div class="gt-lib" aria-hidden="true"><span class="gt-lib-pile">' + libEtat(null) + libEtat(TX.boutique) + '</span><span class="gt-jauge"><i><b></b></i><i><b></b></i></span></div>' +
        '<div class="gt-pille">' +
          '<div class="gt-etat" role="group" aria-label="' + esc(TX.partenaires) + '">' + partenaires + '</div>' +
