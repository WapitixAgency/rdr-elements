...
if ('ResizeObserver' in window) new ResizeObserver(remesurer).observe($('terres-engagements'));
  ...
  class RdrTerresEngagements extends HTMLElement {
    ...
    _tenter(jeu) {
      ...
      if (!jeuValide(D)) {
        if (!this.firstChild) this.innerHTML = "<div class=\"rte-attente\" aria-hidden=\"true\"><div class=\"rte-sq-haut\"><div class=\"rte-sq-trame\"><i class=\"rte-sq-l rte-sq-k\"></i><i class=\"rte-sq-l rte-sq-t\"></i><i class=\"rte-sq-l rte-sq-t rte-sq-t2\"></i><i class=\"rte-sq-l rte-sq-p rte-sq-p1\"></i><i class=\"rte-sq-l rte-sq-p\"></i><i class=\"rte-sq-l rte-sq-p rte-sq-p3\"></i></div></div></div>";
        return;
      }
    ...
    _panne() {
      ...
      this.querySelector('button').addEventListener('click', () => { this.innerHTML = "<div class=\"rte-attente\" aria-hidden=\"true\"><div class=\"rte-sq-haut\"><div class=\"rte-sq-trame\"><i class=\"rte-sq-l rte-sq-k\"></i><i class=\"rte-sq-l rte-sq-t\"></i><i class=\"rte-sq-l rte-sq-t rte-sq-t2\"></i><i class=\"rte-sq-l rte-sq-p rte-sq-p1\"></i><i class=\"rte-sq-l rte-sq-p\"></i><i class=\"rte-sq-l rte-sq-p rte-sq-p3\"></i></div></div></div>"; this._chercher(); });
    }
  }
