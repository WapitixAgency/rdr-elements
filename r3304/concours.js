/* rdr-elements concours | source route-du-rhum bd0e5ed | rdr-concours-photo.js */
try{(window.RDR_ELEMENTS=window.RDR_ELEMENTS||{})["concours"]="bd0e5ed";performance.mark("rdr-elements:concours")}catch(e){}
;(function(){
(function () {
  'use strict';
