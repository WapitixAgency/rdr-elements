/* rdr-elements entete | source route-du-rhum 1e54be5 | rdr-entete.js */
try{(window.RDR_ELEMENTS=window.RDR_ELEMENTS||{})["entete"]="1e54be5";performance.mark("rdr-elements:entete")}catch(e){}
;(function(){
...
const ARBORESCENCE = {
  fr: [
    ...
    { cle: 'village', libelle: 'Village de Saint-Malo', lien: '/saint-malo', panneau: 'villages', dates: SM, sansTout: true, bouton: { libelle: 'Questions fréquentes', lien: '/faq' },
      liens: [
  ...
  en: [
    ...
    { cle: 'skippers', libelle: 'Skippers', lien: '/skippers', panneau: 'skippers',
      liens: [{ libelle: 'Skippers', lien: '/skippers' }] },
    { cle: 'village', libelle: 'Saint-Malo race village', lien: '/saint-malo', panneau: 'villages', dates: SM, sansTout: true, bouton: { libelle: 'FAQ', lien: '/faq' },
      liens: [
...
const COUPES = [
  { c: 105, x: 6.8, y: 5.9, w: 90.4, hh: 92.2, H: 22 },     
  { c: 140, x: 1.3, y: 44.8, w: 137.4, hh: 50.4, H: 16 },   
  { c: 120, x: 20, y: 20, w: 80, hh: 80, H: 22 }            
];
...
function modele() {
  ...
  return MENU.map((e, i) => {
    ...
    return Object.assign(base, {
      ...
      tout: e.bouton && e.bouton.lien ? { libelle: e.bouton.libelle, lien: e.bouton.lien, propre: true } : e.sansTout ? null : rg.boutonLien ? { libelle: rg.boutonLibelle || TXT.toutVoir, lien: rg.boutonLien } : e.lien ? { libelle: TXT.toutVoir, lien: e.lien } : null,
      cartes
    });
  });
}
...
function regionHTML(r) {
  ...
  return '<div class="gl-region gl-region--' + (contenu ? 'contenu' : 'liste') + '" id="gl-r-' + r.cle + '" role="region" aria-labelledby="gl-b-' + r.cle + '" data-cle="' + r.cle + '" hidden>' +
    '<div class="gl-region-tete"><div><p class="gl-kicker">' + esc(r.titre) + '</p>' + (r.sous ? '<p class="gl-lead">' + esc(r.sous) + '</p>' : '') + (r.dispo === 'programme' ? '<p class="gl-lead" data-prog="etat"></p>' : '') + datesHTML(r) + '</div>' +
      '<div class="gl-region-actions">' + (r.tout ? '<a class="gl-tout-lien" href="' + esc(lien(r.tout.lien)) + '"' + cible(r.tout.lien) + '><span>' + esc(r.tout.propre ? r.tout.libelle : TXT.toutVoir) + '</span>' + ICO.fleche + '</a>' : '') + voirImagesHTML() + '</div></div>' +
    corps +
